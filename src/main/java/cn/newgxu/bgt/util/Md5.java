...
/**
 * Salt MD5 加强模块<br>
 * 提供 16 位与 32 位 MD5 加密与其 Salt 加密功能
 * <p>
 * 
 * Salt 加密方法调用：<br>
 * MD5 md5 = new MD5();<br>
...
public class Md5 {
	 ...
	 *            密钥长度
	 */
	private static String getRandomKeyt(int length) throws Exception {
		if (length < 1)
	 ...
	 */
	public static String[] salt32(String plainText) throws Exception {
	 ...
	 * @return 索引 0 是密文，索引 1 是二次密钥
	 */
	public static String[] salt16(String plainText) throws Exception {
	 ...
	 *            加密的方法名称
	 */
	private static String[] salt(String saltFunctionName, String plainText)
			throws Exception {
		String _keyt = getRandomKeyt(_KEYTLENGTH);
		return new String[] {
				(String) Md5.class.getMethod(saltFunctionName,
						Class.forName("java.lang.String")).invoke(Md5.class,
						(cell32(plainText) + _keyt)), _keyt };
	}
}
